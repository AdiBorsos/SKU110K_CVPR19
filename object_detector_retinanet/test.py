...
def PredThisPath(image_path = None):
    csv_data_lst = []
    ...
    image = read_image_bgr(image_p)
    image_name = os.path.join(image_p.split(os.path.sep)[-2], image_p.split(os.path.sep)[-1])


    raw_image = read_image_bgr(image_p)
